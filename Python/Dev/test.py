...
# 기존 이미지들을 덮어둘 이미지 생성
image_cover = np.zeros((1000, 1000, 3), dtype=np.uint8)
image_cover = np.full((1000, 1000, 3), 255, dtype=np.uint8)

image_sum = cv.subtract(mosaic_art, image_cover)

cv.imshow("test", image_sum)
